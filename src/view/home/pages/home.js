...
const Home = () => {
  ...
  useEffect(() => {
    handleShowTasks(userName, 'Home', setErrorTask, setTasks);
  }, [userName, tasks]);
  ...
  return (
    <div className="bg-yellow-200 h-screen w-screen flex flex-col items-center relative">
      <div className="flex flex-col text-center">
        <p className="text-3xl text-gray-500 font-bold mt-16">Home</p>
        <p className="text-base text-gray-500 flex flex-col ml-3">Manage household tasks and projects.</p>
      ...
      {isAddingTask ? (
        <div className="flex flex-col items-center mt-4">
          ...
          <button
            ...
            onClick={() => handleAddingTaskRoute(userName, 'Home', titleTask, textTask, setErrorTask, setIsAddingTask(false))}
          >
            +
          </button>
        </div>
