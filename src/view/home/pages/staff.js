...
const Staff = () => {
  ...
  useEffect(() => {
    handleShowTasks(userName, 'Staff', setErrorTask, setTasks);
  }, [userName, tasks]);
  ...
  return (
    <div className="bg-yellow-200 h-screen w-screen flex flex-col items-center relative">
      <div className="flex flex-col text-center">
        <p className="text-3xl text-green-600 font-bold mt-16">Staff</p>
        <p className="text-base text-green-600 flex flex-col ml-3">Organizes and manages personal tasks efficiently.</p>
      ...
      {isAddingTask ? (
        <div className="flex flex-col items-center mt-4">
          ...
          <button
            ...
            onClick={() => handleAddingTaskRoute(userName, 'Staff', titleTask, textTask, setErrorTask, setIsAddingTask(false))}
          >
            +
          </button>
        </div>
