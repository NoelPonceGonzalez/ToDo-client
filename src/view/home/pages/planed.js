...
const Planed = () => {
  ...
  useEffect(() => {
    handleShowTasks(userName, 'Planed', setErrorTask, setTasks);
  }, [userName, tasks]);
  ...
  return (
    <div className="bg-yellow-200 h-screen w-screen flex flex-col items-center relative">
      <div className="flex flex-col text-center">
        <p className="text-3xl text-purple-500 font-bold mt-16">Planed</p>
        <p className="text-base text-purple-500 flex flex-col ml-3">Visualize your upcoming events.</p>
      ...
      {isAddingTask ? (
        <div className="flex flex-col items-center mt-4">
          ...
          <button
            ...
            onClick={() => handleAddingTaskRoute(userName, 'Planed', titleTask, textTask, setErrorTask, setIsAddingTask(false))}
          >
            +
          </button>
        </div>
