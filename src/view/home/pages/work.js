...
const Work = () => {
  ...
  useEffect(() => {
    handleShowTasks(userName, 'Work', setErrorTask, setTasks);
  }, [userName, tasks]);
  ...
  return (
    <div className="bg-yellow-200 h-screen w-screen flex flex-col items-center relative">
      <div className="flex flex-col text-center">
        <p className="text-3xl text-amber-700 font-bold mt-16">Work</p>
        <p className="text-base text-amber-700 flex flex-col ml-3">Organize your work day efficiently.</p>
        <div className="h-0.5 w-screen bg-yellow-800 mt-4 mb-6" />
      </div>
      ...
      {isAddingTask ? (
        <div className="flex flex-col items-center mt-4">
          ...
          <button
            ...
            onClick={() => handleAddingTaskRoute(userName, 'Work', titleTask, textTask, setErrorTask, setIsAddingTask(false))}
          >
            +
          </button>
        </div>
