...
const Today = () => {
  ...
  useEffect(() => {
    handleShowTasks(userName, 'Today', setErrorTask, setTasks);
  }, [userName, tasks]);
  ...
  return (
    <div className="bg-yellow-200 h-screen w-screen flex flex-col items-center relative">
      <div className="flex flex-col text-center">
        <p className="text-3xl text-red-500 font-bold mt-16">Today</p>
        <p className="text-base text-red-500 flex flex-col ml-3">
        Plan and achieve your daily goals.</p>
      ...
      {isAddingTask ? (
        <div className="flex flex-col items-center mt-4">
          ...
          <button
            ...
            onClick={() => handleAddingTaskRoute(userName, 'Today', titleTask, textTask, setErrorTask, setIsAddingTask(false))}
          >
            +
          </button>
        </div>
